export const ChangePasswordTemplate = (reset_link: string) => {
    return `
        <center>
            ...
            <td id="m_8986478188185155053bodyCell" style="margin:0;padding:0;font-family:Helvetica,Arial,sans-serif;height:100%!important" valign="top" align="center">
                ...
                <div style="background-color:#ffffff;color:#353740;padding:40px 20px;text-align:left;line-height:1.5">
                  ...
                  <p style="font-size:16px;line-height:24px">
                    Để tiến hành thay đổi mật khẩu cho tài khoản Arcanic AI, hãy nhấn vào nút bên dưới và làm theo hướng dẫn.
                  </p>
                  <p style="margin:24px 0 0;text-align:left">
                    <a href="${reset_link}" target="_blank" style="display:inline-block;text-decoration:none;background:#2222FF;border-radius:3px;color:white;font-family:Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:400;padding:12px 20px 11px;margin:0px">
                        thay đổi mật khẩu
                    </a>
                  </p>
                </div>
                <div style="text-align:left;background:#ffffff;color:#6e6e80;padding:0 20px 20px;font-size:13px;line-height:1.4">
                    <p style="margin:0">
                    Đường dẫn này sẽ chỉ tồn tại trong 3 ngày. Trong trường hợp bạn không yêu cầu thay đổi mật khẩu cho tài khoản Arcanic AI, vui lòng bỏ qua email này.
                    </p>
                </div>
              </td>
            </tr>
